package com.yesimyildirim.kotlinfirebaseinsta
...
class FeedRecyclerAdapter(private val userEmailArray:ArrayList<String>,private val usercommentArrayList: ArrayList<String>,private val userImageArray :ArrayList<String>) :RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> (){
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        holder.recyclerCommentText?.text = usercommentArrayList[position]
